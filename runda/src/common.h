...
#ifndef RUNDA_COMMON_H_
#define RUNDA_COMMON_H_
...
#define COPYRIGHT "RuNda: Yet Another Part-of-Speech and Morphological Analyzer\n\
...
#ifdef RUNDA_USE_UTF8_ONLY
#define RUNDA_DEFAULT_CHARSET "UTF-8"
#endif

#ifndef RUNDA_DEFAULT_CHARSET
#if defined(_WIN32) && !defined(__CYGWIN__)
#define RUNDA_DEFAULT_CHARSET "SHIFT-JIS"
#else
#define RUNDA_DEFAULT_CHARSET "EUC-JP"
#endif
#endif
...
#ifdef _WIN32
#ifdef __GNUC__
#define WPATH_FORCE(path) (RuNda::Utf8ToWide(path).c_str())
